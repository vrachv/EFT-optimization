...
- Нажмите клавишу **Win** и напишите `cmd`, щелкните ПКМ по первому результату и выберите **Запуск от имени администратора**
- Скопируйте `powercfg -duplicatescheme e9a42b02-d5df-448d-aa00-03f14749eb61`, вставьте в командную строку и нажмите **enter**
- Перезагрузите компьютер
